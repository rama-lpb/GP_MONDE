                            ...
                            <div class="px-6 py-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="flex flex-col">
                                        ...
                                        <input type="text" class="border-2 border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-700 transition-colors" name="destinataire_nom" required>
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input type="text" class="border-2 border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-700 transition-colors" name="destinataire_prenom" required>
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input type="tel" class="border-2 border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-700 transition-colors" name="destinataire_telephone" required>
                                    ...
                                    <div class="flex flex-col col-span-1 md:col-span-2">
                                        ...
                                        <textarea class="border-2 border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-700 min-h-[100px] transition-colors" name="destinataire_adresse" required></textarea>
